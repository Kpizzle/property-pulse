...
import { FaArrowLeft, FaBookmark, FaBed, FaBath, FaRulerCombined, FaTimes, FaCheck, FaMapMarker } from 'react-icons/fa';
    ...
    <main>
      ...
      <div className='bg-white p-6 rounded-lg shadow-md mt-6'>
        ...
        <div className='flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9'>
          <p>
            <FaBed className='inline-block mr-2' /> 3<span className='hidden sm:inline'>Beds</span>
          </p>
          <p>
            <FaBath className='inline-block mr-2' /> 2<span className='hidden sm:inline'>Baths</span>
          </p>
          <p>
        ...
        <p className='text-gray-500 mb-4'>
          We have a beautiful apartment located near the commons. It is a 2 bedroom apartment with a full kitchen and bathroom. It is available htmlFor weekly or monthly rentals.
        </p>
      </div>
